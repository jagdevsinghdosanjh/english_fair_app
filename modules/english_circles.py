...
def render():
    ...
    word = st.selectbox("Choose a word to explore:", ["disciple","discipline","festival","apple", "run", "happy", "school", "friend","book","laugh","tree","kind","water","play","light","home","dream","learn","fearless"])
    ...
    st.markdown("No fear of death, no snare of desire, Where the soul is free, there burns Abhay’s fire. With constant wisdom and purity’s grace, Abhay is the lamp that enlightens every place.")
    st.markdown("---")
