...
def render():
    ...
    st.markdown("No fear of death, no snare of desire, Where the soul is free, there burns Abhay’s fire. With constant wisdom and purity’s grace, Abhay is the lamp that lights every place.")
    st.markdown("---")
